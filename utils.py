...
def create_feature (file, env_feature, data_dir, Path_Pickle_Feature) :
    ...
    fasta_file = file.get_fasta_file()
    cmd = f"create_individual_features.py --fasta_paths=./{fasta_file} \--data_dir={data_dir} \--save_msa_files=True \--output_dir={Path_Pickle_Feature} \--max_template_date=2050-05-02 \--skip_existing=True \--use_mmseqs2=True"
    os.system(cmd)
