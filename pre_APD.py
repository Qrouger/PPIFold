...
class pre_APD() :
    ...
    def __init__(self) :
        ...
        #self.create_fasta_file()
           ...
           #self.remove_SP()
        #self.create_feature(args.env_feature,args.data_dir)
        #self.Make_all_MSA_coverage()
        #self.generate_APD_script(args.max_aa)
        if args.make_multimers == True :
            #self.Make_all_vs_all(args.env_multimer,args.data_dir)
            #self.add_iQ_score_and_make_cyt(args.dir_alpha_analysis)
            #self.create_out_fig()
            #self.Make_homo_oligo(args.env_multimer,args.data_dir)
            self.add_hiQ_score(args.dir_alpha_analysis)
...
### Generating Multimers
    ...
    def add_iQ_score_and_make_cyt (self, dir_alpha) :
        ...
        with open("result_all_vs_all/table_for_network.cyt","w") as file3 :
